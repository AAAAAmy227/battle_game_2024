#include "battle_game/core/bullets/MP_bullet_no_harm.h"
#include "battle_game/core/units/blitz.h"
#include "battle_game/core/game_core.h"
#include "battle_game/core/particles/particles.h"
#include<algorithm>
namespace battle_game::bullet {
MPBulletNoHarm::MPBulletNoHarm(GameCore *core,
                   uint32_t id,
                   uint32_t unit_id,
                   uint32_t player_id,
                   glm::vec2 position,
...
void MPBulletNoHarm::Render() {
  SetTransformation(position_, rotation_, glm::vec2{0.7f});
  SetColor(game_core_->GetPlayerColor(player_id_));
  SetTexture(BATTLE_GAME_ASSETS_DIR "textures/doge.png");
  DrawModel(0);
}

void MPBulletNoHarm::Update() {
